# Connect from ChatGPT - OpenAI Apps SDK
...
Please note that publishing your app for public access is not available at the moment, but we will accept submissions later this year. You can learn more in our [ChatGPT app review guidelines](https://developers.openai.com/apps-sdk/app-developer-guidelines).
...
4. Prompt the model to invoke tools by saying something related to your app. For example, "What are my available tasks?" for a Kanban board app.
