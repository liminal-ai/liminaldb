...
![Mandeep Singh](https://cookbook.openai.com/_next/image?url=https%3A%2F%2Favatars.githubusercontent.com%2Fu%2F168678187%3Fv%3D4&w=64&q=75)

![Verified](https://cookbook.openai.com/_next/static/media/openai-logomark-2.63a8dac2.svg)

![Emre Okcular](https://cookbook.openai.com/_next/image?url=https%3A%2F%2Favatars.githubusercontent.com%2Fu%2F26163154%3Fv%3D4&w=64&q=75)

Mandeep Singh(OpenAI), Emre Okcular

[Open in GitHub](https://github.com/openai/openai-cookbook/blob/main/examples/gpt-5/gpt-5-2_prompting_guide.ipynb) [View as Markdown](https://nbviewer.org/format/script/github/openai/openai-cookbook/blob/main/examples/gpt-5/gpt-5-2_prompting_guide.ipynb)

- [1\. Introduction](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#1-introduction)
- [2\. Key behavioral differences](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#2-key-behavioral-differences)
- [3\. Prompting patterns](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#3-prompting-patterns)
- [4\. Compaction (Extending Effective Context)](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#4-compaction-extending-effective-context)
- [5\. Agentic steerability & user updates](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#5-agentic-steerability--user-updates)
- [6\. Tool-calling and parallelism](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#6-tool-calling-and-parallelism)
- [7\. Structured extraction, PDF, and Office workflows](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#7-structured-extraction-pdf-and-office-workflows)
- [8\. Prompt Migration Guide to GPT 5.2](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#8-prompt-migration-guide-to-gpt-52)
- [9\. Web search and research](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#9-web-search-and-research)
- [10\. Conclusion](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#10-conclusion)
- [Appendix](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide#appendix)
...
### [3.1 Controlling verbosity and output shape](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide\#31-controlling-verbosity-and-output-shape)
...
### [3.2 Preventing Scope drift (e.g., UX / design in frontend tasks)](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide\#32-preventing-scope-drift-eg-ux--design-in-frontend-tasks)
...
### [3.3 Long-context and recall](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide\#33-long-context-and-recall)
...
### [3.4 Handling ambiguity & hallucination risk](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide\#34-handling-ambiguity--hallucination-risk)
...
### [Example prompt for a web research agent:](https://cookbook.openai.com/examples/gpt-5/gpt-5-2_prompting_guide\#example-prompt-for-a-web-research-agent)
